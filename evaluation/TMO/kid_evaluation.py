...
target_folder = './results/HDReye/KK_TMO/single_boost'
real_folder = './results/HDReye/KK_TMO/GT'

real_image_paths = []
generated_image_paths = []

for path in os.listdir(target_folder):
    generated_image_paths.append(os.path.join(target_folder, path, 'inpaint.png'))


for path in os.listdir(real_folder):
    real_image_paths.append(os.path.join(real_folder, path, 'GT.png'))
